...
assert.match(indexHtml, /href="docs\/model-methodology\.html"/);
...
assert.match(methodologyHtml, /href="\.\.\/index\.html">← Back to model<\/a>/);
...
console.log(JSON.stringify({ status: "passed", assertions: 115, base, aggressive, conservative, previews: { contract: contract.model, agency: agency.model, phase: phase.model } }, null, 2));
